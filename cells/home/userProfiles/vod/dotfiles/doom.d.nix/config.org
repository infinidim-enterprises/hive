...
** Sly
#+begin_src emacs-lisp :tangle packages.el
(package! sly :built-in t)
(package! sly-asdf :built-in t)
(package! sly-overlay :built-in t)
(package! sly-quicklisp :built-in t)
(package! sly-macrostep :built-in t)
(package! sly-repl-ansi-color :built-in t)
(package! sly-named-readtables :built-in t)
#+end_src
