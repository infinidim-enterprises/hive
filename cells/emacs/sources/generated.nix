...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  doom-emacs = {
    pname = "doom-emacs";
    version = "7bc39f2c1402794e76ea10b781dfe586fed7253b";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = true;
      sha256 = "sha256-bEvS68Q/KwVJU97f2Q+jRG7Z4PJPfWDr8rw4HAbCI3E=";
    };
    date = "2024-11-14";
  };
  grip = {
  ...
  lsp-bridge = {
    pname = "lsp-bridge";
    version = "41530f4dfafa63ebb6b510cdcf2bef0e5757b56a";
    src = fetchFromGitHub {
