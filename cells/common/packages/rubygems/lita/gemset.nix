{
  ...
  http_router = {
    dependencies = [ "rack" "url_mount" ];
    groups = [ "default" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "0nicbn8a0ql773yyn4yqqpir0agz7j4h2jax493is685zbr3rzmz";
      type = "gem";
    };
    version = "0.11.2";
  };
  ...
  lita = {
    dependencies = [ "faraday" "http_router" "i18n" "ice_nine" "multi_json" "puma" "rack" "rb-readline" "redis-namespace" "thor" ];
    groups = [ "default" ];
    platforms = [ ];
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "1kmvav9ncfn6j7k0spkjak57449yh8mfvm23yi6pp99p7pv1q32a";
      type = "gem";
    };
    version = "4.8.0";
  };
  ...
  url_mount = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "1bb60lx7im05c8yad1qgjmkcwaqi3hpdz7v744a0lmgd12fqzfa4";
      type = "gem";
    };
    version = "0.2.1";
  };
