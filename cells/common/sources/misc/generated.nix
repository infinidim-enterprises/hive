...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  langchain = {
    pname = "langchain";
    version = "langchain-openai==0.1.6";
    src = fetchFromGitHub {
      owner = "langchain-ai";
      repo = "langchain";
      rev = "langchain-openai==0.1.6";
      fetchSubmodules = false;
      sha256 = "sha256-dNxBfdt0FFzbI2HIh7MNonGeSF+Tw3VXzJwkjOl806A=";
    };
  };
  ledger-live-desktop = {
  ...
  pbkdf2-sha512 = {
    pname = "pbkdf2-sha512";
    version = "d1e72c52d036c600078d66530d01d4afb1ffa933";
    src = fetchurl {
