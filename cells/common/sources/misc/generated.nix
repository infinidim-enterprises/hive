...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  adguard-filters_adguardteam = {
    ...
    version = "9c0435ccd45e80da9ffa3bf7c3bf348255fe2bcf";
    src = fetchgit {
      url = "https://github.com/AdguardTeam/AdguardFilters";
      rev = "9c0435ccd45e80da9ffa3bf7c3bf348255fe2bcf";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-tCoW1Wn21DAQZ89A4cm02WvbCahCWrMG0tf/A+1TgbY=";
    };
    date = "2025-06-06";
  };
  adguard-filters_romania = {
    pname = "adguard-filters_romania";
    version = "43d7401f1a2dd2b4d789f90e4bb1008c787d08fa";
    src = fetchgit {
      url = "https://github.com/tcptomato/ROad-Block";
      rev = "43d7401f1a2dd2b4d789f90e4bb1008c787d08fa";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-C/FwuB867DdK5UT/CTH8eO2l8tbD8JlH6yfikr9HiGg=";
    };
    date = "2025-05-26";
  };
  base16-schemes = {
    pname = "base16-schemes";
    version = "de3eeb6add0a6051bfc717684e36c8c9a78a1812";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-C8VZuwzaQfNYbQQcc0Fh4RS+1nqc6j+IOy80NGmV4IQ=";
    };
    date = "2025-06-04";
  };
  ...
  chatgpt-wrapper = {
    ...
    version = "e13688c174c2e38c52d998efdda61a48966ca6f3";
    src = fetchFromGitHub {
      owner = "llm-workflow-engine";
      repo = "llm-workflow-engine";
      rev = "e13688c174c2e38c52d998efdda61a48966ca6f3";
      fetchSubmodules = false;
      sha256 = "sha256-thQGberqDkRBoFpH7KCg8lZQLuAPiELpsYkk8AoCmKw=";
    };
    date = "2025-05-26";
  };
  cl-hash-util = {
  ...
  ipxe = {
    pname = "ipxe";
    version = "5b3ebf8b24ae40a6f9f9f78491702d508f843e56";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-uGR82lR6gpp6IKBVDsKYLtovnbTiWg3RgbVQt6mug+I=";
    };
    date = "2025-06-02";
  };
  iterable-io = {
  ...
  langchain = {
    pname = "langchain";
    version = "langchain-core==0.3.64";
    src = fetchFromGitHub {
      owner = "langchain-ai";
      repo = "langchain";
      rev = "langchain-core==0.3.64";
      fetchSubmodules = false;
      sha256 = "sha256-KbGqEio88v+gf6dpr6UEzODWf45VL6GjpUKgg3/edLM=";
    };
  };
  listopia = {
    pname = "listopia";
  ...
  nur = {
    pname = "nur";
    version = "b867f29b2dd10e29477a15aebc4c3f6354ca723d";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-Dwwn4G27Tb3ErlErOThqXI+bIJ3usoHogzmFE20XgBw=";
    };
    flake = "true";
    date = "2025-06-06";
  };
