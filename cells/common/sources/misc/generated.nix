...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  adguard-filters_adguardteam = {
    ...
    version = "1cd8dd8629f2ee09e4903e61c2751e75f0661dd9";
    src = fetchgit {
      url = "https://github.com/AdguardTeam/AdguardFilters";
      rev = "1cd8dd8629f2ee09e4903e61c2751e75f0661dd9";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-bwvzWhPt7PmZdJYg1LFBr5wLltBqjhQ0UR6HLx9BxBI=";
    };
    date = "2025-09-13";
  };
  adguard-filters_romania = {
    pname = "adguard-filters_romania";
    version = "587ae025d5dfa87ec3693cdd13f5ed8e99540d5a";
    src = fetchgit {
      url = "https://github.com/tcptomato/ROad-Block";
      rev = "587ae025d5dfa87ec3693cdd13f5ed8e99540d5a";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-Xvnvh25KOmBSJfiTNZGjouq+vEHpi7tguBMHOJ1Q1gU=";
    };
    date = "2025-09-11";
  };
  base16-schemes = {
  ...
  chatgpt-wrapper = {
    ...
    version = "79cb98d22c6acbb34603f9a7ee156a9b45a39201";
    src = fetchFromGitHub {
      owner = "llm-workflow-engine";
      repo = "llm-workflow-engine";
      rev = "79cb98d22c6acbb34603f9a7ee156a9b45a39201";
      fetchSubmodules = false;
      sha256 = "sha256-fntzImlwhl7zwqvYUo0mJFgCrjXwkhHyxg5yuwTZqas=";
    };
    date = "2025-08-11";
  };
  cl-hash-util = {
  ...
  ipxe = {
    pname = "ipxe";
    version = "969ce2c559a6841a949a1b73a3967b1889e0c999";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-a9Nmo9ZAzbsePwS/LFh3qMMfsezu0194WV98BXhiT0Y=";
    };
    date = "2025-08-29";
  };
  iterable-io = {
  ...
  langchain = {
    ...
    src = fetchFromGitHub {
      owner = "langchain-ai";
      repo = "langchain";
      rev = "langchain-core==0.3.76";
      fetchSubmodules = false;
      sha256 = "sha256-PoFqOUyYYEgltUplpOYjHp6owyla8cDrxgsp4izjDHI=";
    };
  };
  listopia = {
    pname = "listopia";
  ...
  nur = {
    pname = "nur";
    version = "567f0297e5c1fdf9484b30319727e8e587456ce9";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-LqbyKrFIcgKJxkQfDenOELErQyugbw2SaQ2A7hkmmYA=";
    };
    flake = "true";
    date = "2025-09-13";
  };
  ...
  pynitrokey = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.10.0";
      fetchSubmodules = false;
      sha256 = "sha256-COJoKRhHrpZvCKzv3v2INdA88nH5HN4FsB9fXPTUbDY=";
    };
  };
  python-pass = {
    pname = "python-pass";
