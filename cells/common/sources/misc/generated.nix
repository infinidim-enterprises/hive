...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  adguard-filters_adguardteam = {
    ...
    version = "f7b28119ddbae732feba2b7ae6bea3f481a35b39";
    src = fetchgit {
      url = "https://github.com/AdguardTeam/AdguardFilters";
      rev = "f7b28119ddbae732feba2b7ae6bea3f481a35b39";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-t13XvGb9/fKp3sFNPS1fT2t6FrMwJ7Dh/cDqMr7Fzs0=";
    };
    date = "2024-10-04";
  };
  ...
  pbkdf2-sha512 = {
    pname = "pbkdf2-sha512";
    version = "92248b23e5925b7a69108488e1f6d4577eea9f76";
    src = fetchurl {
