...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  adguard-filters_adguardteam = {
    ...
    version = "307716596274a58ba55c02b02558c980005ffc32";
    src = fetchgit {
      url = "https://github.com/AdguardTeam/AdguardFilters";
      rev = "307716596274a58ba55c02b02558c980005ffc32";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-WJGJTNCM9qItp8aN4ptZD7kDaNi0Y8h7+VEun0+5Z00=";
    };
    date = "2024-12-14";
  };
  adguard-filters_romania = {
    pname = "adguard-filters_romania";
    version = "db0b271a835e0538d738c87a0c847f24ecec26ec";
    src = fetchgit {
      url = "https://github.com/tcptomato/ROad-Block";
      rev = "db0b271a835e0538d738c87a0c847f24ecec26ec";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-UVOh3+GrqCVTPmG/I6SDUqtFQYZCY49QUMOkPnIQs/A=";
    };
    date = "2024-12-12";
  };
  age-plugin-trezor = {
  ...
  base16-schemes = {
    ...
    version = "d5024d07713029d21aa45263e164913a0dfab0b6";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-PXah6e8PK41T9vONsh9X4AVSO0Nq6OtwN4Hd22GizVo=";
    };
    date = "2024-12-09";
  };
  chatgpt-wrapper = {
  ...
  langchain = {
    pname = "langchain";
    version = "langchain-core==0.3.24";
    src = fetchFromGitHub {
      owner = "langchain-ai";
      repo = "langchain";
      rev = "langchain-core==0.3.24";
      fetchSubmodules = false;
      sha256 = "sha256-Wi1r+NZzYKIKJZsX8bpPSxXCivah4rBAOvIEansmtOM=";
    };
  };
  ledger-live-desktop = {
  ...
  pbkdf2-sha512 = {
    pname = "pbkdf2-sha512";
    version = "6ff5642249be62131aed96fc50111a9eea834f91";
    src = fetchurl {
  ...
  stumpwm-contrib = {
    ...
    version = "c4f077b1fe97cd8da6d710e5cbe390eb680629bd";
    src = fetchFromGitHub {
      owner = "stumpwm";
      repo = "stumpwm-contrib";
      rev = "c4f077b1fe97cd8da6d710e5cbe390eb680629bd";
      fetchSubmodules = false;
      sha256 = "sha256-1q42E6HCsUod/W/0abTQdAdwgKHhTtXIJUYxmkEjuzk=";
    };
    date = "2024-12-07";
  };
  stumpwm-git = {
