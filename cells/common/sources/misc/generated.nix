...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  adguard-filters_adguardteam = {
    ...
    version = "0b7f2be0b541f7c34cc3fbf47c06c9d67667701f";
    src = fetchgit {
      url = "https://github.com/AdguardTeam/AdguardFilters";
      rev = "0b7f2be0b541f7c34cc3fbf47c06c9d67667701f";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-d+NrIia6fcyxxXLgzQl/CL6Ruz5sAgf8YcYfmSNKMz4=";
    };
    date = "2025-08-15";
  };
  ...
  base16-schemes = {
    ...
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-8KG2lXGaXLUE0F/JVwLQe7kOVm21IDfNEo0gfga5P4M=";
    };
    date = "2025-08-10";
  };
  ...
  git-get = {
    pname = "git-get";
    version = "71e7f760635a2e32e726f318b469d3f348dcb298";
    src = fetchFromGitHub {
      owner = "grdl";
      repo = "git-get";
      rev = "71e7f760635a2e32e726f318b469d3f348dcb298";
      fetchSubmodules = false;
      sha256 = "sha256-8yOKJ5yxEG3GHxHDyYDAfADWg7v7DjwW/F3FETQlXrI=";
    };
  ...
  ipxe = {
    pname = "ipxe";
    version = "a53ec449327788e2015642bff21443d3a399c05b";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-rcRWkuOgtHs6ZzcECbsVXCN+HS5cG/HlrVPP5+ZF+EM=";
    };
    date = "2025-08-13";
  };
  iterable-io = {
  ...
  langchain = {
    pname = "langchain";
    version = "langchain-core==0.3.74";
    src = fetchFromGitHub {
      owner = "langchain-ai";
      repo = "langchain";
      rev = "langchain-core==0.3.74";
      fetchSubmodules = false;
      sha256 = "sha256-oF/IK7Z0L7Z4I9d5JjUCAbQnvQZ8hX7PZXXnVlOUy6A=";
    };
  };
  listopia = {
    pname = "listopia";
  ...
  nur = {
    pname = "nur";
    version = "43d5a0b27087d0b592f985e5368ce14cb157c532";
    src = fetchgit {
      url = "https://github.com/nix-community/NUR";
      rev = "43d5a0b27087d0b592f985e5368ce14cb157c532";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-94V3rHf97o7ogdWs27+cwVYAiQm95te2DIj5pkaxq0A=";
    };
    flake = "true";
    date = "2025-08-16";
  };
