...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  adguard-filters = {
    ...
    version = "5076c7c53a33836f6a76a0bcd5d8c0ca18621161";
    src = fetchgit {
      url = "https://github.com/AdguardTeam/AdguardFilters";
      rev = "5076c7c53a33836f6a76a0bcd5d8c0ca18621161";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-tCGrUknFylJjC5aY0fjLKug+WhQCEH6iN+TflFmHpYc=";
    };
    date = "2024-06-03";
  };
  age-plugin-trezor = {
  ...
  chatgpt-wrapper = {
    ...
    version = "0423590dc9727db6dc6592a2f50040e100863c6b";
    src = fetchFromGitHub {
      owner = "llm-workflow-engine";
      repo = "llm-workflow-engine";
      rev = "0423590dc9727db6dc6592a2f50040e100863c6b";
      fetchSubmodules = false;
      sha256 = "sha256-KgHTMXv3wBVGfbS59k5eOy1TXINMsVF51uP6dHwamPM=";
    };
    date = "2024-06-02";
  };
  cl-hash-util = {
  ...
  pam_usb = {
    pname = "pam_usb";
    version = "09aeaeccfae20a815161467e31e41bb5c6ce2d7f";
    src = fetchgit {
      url = "https://github.com/mcdope/pam_usb";
      rev = "09aeaeccfae20a815161467e31e41bb5c6ce2d7f";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
  ...
  pbkdf2-sha512 = {
    pname = "pbkdf2-sha512";
    version = "fc6e6b8ffb440710f291883c480e5b7f9c5dd6f9";
    src = fetchurl {
