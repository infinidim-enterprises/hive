...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  adguard-filters_adguardteam = {
    ...
    version = "68e3c0e5ff785fa8a94c043157186434e3a56fb7";
    src = fetchgit {
      url = "https://github.com/AdguardTeam/AdguardFilters";
      rev = "68e3c0e5ff785fa8a94c043157186434e3a56fb7";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-/teESGOSke7poMtCpPXvT3aYMu+zPK0U/YkIUGgOP80=";
    };
    date = "2024-08-10";
  };
  ...
  pbkdf2-sha512 = {
    pname = "pbkdf2-sha512";
    version = "aaf406a7eb671f493337689164cc5fefe4379918";
    src = fetchurl {
