...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  adguard-filters_adguardteam = {
    ...
    version = "d1a9599174f099f72ed2af562f17b757252ced31";
    src = fetchgit {
      url = "https://github.com/AdguardTeam/AdguardFilters";
      rev = "d1a9599174f099f72ed2af562f17b757252ced31";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-y3m4y8o+xmg1i2u0u6xx/D9qFmhUCKHoz1XX/PZrWEM=";
    };
    date = "2025-10-31";
  };
  adguard-filters_romania = {
    pname = "adguard-filters_romania";
    version = "b7c5d485feb0a9875b4874a2d843512a41064483";
    src = fetchgit {
      url = "https://github.com/tcptomato/ROad-Block";
      rev = "b7c5d485feb0a9875b4874a2d843512a41064483";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-Sith6NbLKqc/ruRcT/0IqTiXYmWoaHS1DnYStlMIvi0=";
    };
    date = "2025-10-31";
  };
  base16-schemes = {
  ...
  chatgpt-wrapper = {
    ...
    version = "781e71eafe815881548d36da41184e9eea1d9088";
    src = fetchFromGitHub {
      owner = "llm-workflow-engine";
      repo = "llm-workflow-engine";
      rev = "781e71eafe815881548d36da41184e9eea1d9088";
      fetchSubmodules = false;
      sha256 = "sha256-PXi2yC4uT7mbKDfJmnMLZzGFw7SzMYKMhGF/GjT+duA=";
    };
    date = "2025-10-06";
  };
  cl-hash-util = {
  ...
  git-get = {
    pname = "git-get";
    version = "70b936e063ab63c36e8c4747c2bb50a0df42e649";
    src = fetchFromGitHub {
      owner = "grdl";
      repo = "git-get";
      rev = "70b936e063ab63c36e8c4747c2bb50a0df42e649";
      fetchSubmodules = false;
      sha256 = "sha256-uxm67vxtmXITl2EmoUNirAx6QjwchNwexoCbC4knf4A=";
    };
  ...
  ipxe = {
    pname = "ipxe";
    version = "fde35ff003a610eca04db0e11fb81e8dfee8a681";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-wDdqP+EgZqAx+44oy/2x36ZuDJPbTSiiztAISbaVi3o=";
    };
    date = "2025-10-29";
  };
  iterable-io = {
  ...
  langchain = {
    pname = "langchain";
    version = "langchain-core==1.0.2";
    src = fetchFromGitHub {
      owner = "langchain-ai";
      repo = "langchain";
      rev = "langchain-core==1.0.2";
      fetchSubmodules = false;
      sha256 = "sha256-YZniL2B1clXO8AvQwJJCX4s4yDi7PSjo82SeB6A1w14=";
    };
  };
  listopia = {
    pname = "listopia";
  ...
  nur = {
    pname = "nur";
    version = "dcc7e6869322d2428e68576213d54a6a3a8d4173";
    src = fetchgit {
      url = "https://github.com/nix-community/NUR";
      rev = "dcc7e6869322d2428e68576213d54a6a3a8d4173";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-lddZrLce1yluoaBaGl5/eTS/X3bzQ6wpyU4knXkuE24=";
    };
    flake = "true";
    date = "2025-11-01";
  };
  ...
  pynitrokey = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.11.1";
      fetchSubmodules = false;
      sha256 = "sha256-BGG/EsGBNYuTl9wTDlpjWNom3vRJbXQ/yOqsHTvx/W4=";
    };
  };
  python-pass = {
    pname = "python-pass";
