...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  zsh-plugin_oh-my-zsh = {
    ...
    version = "d0bddee6e3703e78f588d037078606d41a4d6237";
    src = fetchgit {
      url = "https://github.com/robbyrussell/oh-my-zsh";
      rev = "d0bddee6e3703e78f588d037078606d41a4d6237";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-aFtg7Egxs96G/tatDFKB53ACs5VewHwwgaH197gIguE=";
    };
    date = "2024-03-15";
  };
  zsh-plugin_tipz = {
  ...
  zsh-plugin_zsh-completions = {
    ...
    version = "507f1f8715edd9f1f403c140fa332644d81ebab5";
    src = fetchgit {
