...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  getoptions = {
    pname = "getoptions";
    version = "68a7daf84a09f096672b1a97374d64c2860f4523";
    src = fetchFromGitHub {
      owner = "ko1nksm";
      repo = "getoptions";
      rev = "68a7daf84a09f096672b1a97374d64c2860f4523";
      fetchSubmodules = false;
      sha256 = "sha256-Gx8Li+EJ1XaZFRrdfJaHvjHeS+JTsrzXkTqEKWPGod8=";
    };
    date = "2024-08-10";
  };
  lorri = {
  ...
  shellspec = {
    pname = "shellspec";
    version = "cb649abb6913b52ef2be8cddd364b7704916ee65";
    src = fetchFromGitHub {
      owner = "shellspec";
      repo = "shellspec";
      rev = "cb649abb6913b52ef2be8cddd364b7704916ee65";
      fetchSubmodules = false;
      sha256 = "sha256-SUB5gKqDj6TII8kmHFsmP01zYou8A6jEhs4EP3CQhG4=";
    };
    date = "2024-08-08";
  };
  shflags = {
  ...
  zsh-plugin_zsh-completions = {
    ...
    version = "e897589c9665750a6a21077c8d96c15dd0efc867";
    src = fetchgit {
      url = "https://github.com/zsh-users/zsh-completions";
      rev = "e897589c9665750a6a21077c8d96c15dd0efc867";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-kfqcqBWahKjnzp/N4V4uSmUso9KQDSQgnMlaJIjXjdw=";
    };
    date = "2024-08-04";
  };
