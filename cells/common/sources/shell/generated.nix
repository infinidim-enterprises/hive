...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  atuin = {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "sha256-FJEXIxdeg6ExXvrQ3dtugMK5xw+NwWyB+ld9rj7okoU=";
    };
    flake = "true";
  };
  console-solarized = {
  ...
  dircolors-solarized = {
    ...
    version = "13c1af03d398f46957e22cec6b001e5663ed473e";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-abaFq/8+UAQLfbzCuFH2uglN8ugafTp2Evk4+dchylo=";
    };
    date = "2025-08-01";
  };
  getoptions = {
  ...
  zsh-plugin_oh-my-zsh = {
    ...
    version = "9e23925b8581d22033f07f1983587412d3761494";
    src = fetchgit {
  ...
  zsh-plugin_zsh-completions = {
    ...
    version = "b48b5de9d86708667204d95e8f2490b0952ad2c8";
    src = fetchgit {
      url = "https://github.com/zsh-users/zsh-completions";
      rev = "b48b5de9d86708667204d95e8f2490b0952ad2c8";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-BCuIs3bKsnx733aeYQzcCwjDahXobdFHi7owCjxoGCI=";
    };
    date = "2025-09-05";
  };
