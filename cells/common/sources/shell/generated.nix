...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  atuin = {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "sha256-bfSa3RtVXxHt3usDqqpE/oXKKDUZOrf+tD9uL59fr6M=";
    };
    flake = "true";
  };
  console-solarized = {
  ...
  dircolors-solarized = {
    ...
    version = "38971d217512a23391139fcee2a520eba7cddf37";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-UlSbg3njsVV7+Dlu5CXAmz7BcyihDIVwiWFzV157RSw=";
    };
    date = "2025-09-22";
  };
  getoptions = {
  ...
  zsh-plugin_clipboard = {
    ...
    version = "c3a4a054cefe313d853dc9c32debb1b18aa7513c";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-XtS5HQ2HFYBoBZikuI82XT4MDcXsaPJioI7zNyBoIhs=";
    };
    date = "2025-09-09";
  };
  ...
  zsh-plugin_oh-my-zsh = {
    ...
    version = "43e880ba45d2785ed0dda3dcaf7b5cd610eb3063";
    src = fetchgit {
      url = "https://github.com/robbyrussell/oh-my-zsh";
      rev = "43e880ba45d2785ed0dda3dcaf7b5cd610eb3063";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-dQC9bBGnQ6xyvmxJ9YVktmRJ6BoROo+CAivttbgeRsQ=";
    };
    date = "2025-10-30";
  };
  zsh-plugin_tipz = {
  ...
  zsh-plugin_zsh-completions = {
    ...
    version = "1262853ed328c88fc2a304805ba3b5c15c9bf9ca";
    src = fetchgit {
      url = "https://github.com/zsh-users/zsh-completions";
      rev = "1262853ed328c88fc2a304805ba3b5c15c9bf9ca";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-z/xetKQ3l78wAmsr82Z3URmijG02Hj5xMgKmYoQCkIg=";
    };
    date = "2025-10-30";
  };
